...
//
// The overloads live in a namespace that is then opened, rather than at global scope.
// <cmath> already puts abs/sqrt/exp there on some standard libraries, and redefining
// them is an error -- whereas an opened namespace merely joins overload resolution,
// where an exact float match beats the int and double candidates.
