...
#pragma region Niagara Push
	...
	void PushToNiagara(UNiagaraComponent* Component, const FVector& VirtualTraversal, const FVector& NCenter = FVector::ZeroVector) const
	{
		...
		UNiagaraDataInterfaceArrayFunctionLibrary::SetNiagaraArrayVector(Component, NiagaraBufferParams::Positions, CellLocal);
		...
		if (Rotations.Num() > 0) UNiagaraDataInterfaceArrayFunctionLibrary::SetNiagaraArrayVector(Component, NiagaraBufferParams::Rotations, Rotations);
	}
